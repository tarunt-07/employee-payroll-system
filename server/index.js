...
var ASM_CONSTS = {
  71184: ($0, $1, $2) => { if (typeof window.updatePayrollMetrics === "function") { window.updatePayrollMetrics($0, $1, $2); } },  
 71288: () => { if (typeof window.clearPayslipCard === "function") { window.clearPayslipCard(); } },  
 71374: ($0, $1, $2, $3, $4, $5, $6, $7) => { if (typeof window.showPayslipCard === "function") { window.showPayslipCard( UTF8ToString($0), UTF8ToString($1), UTF8ToString($2), $3, $4, $5, $6, UTF8ToString($7) ); } },  
 71546: () => { if (typeof FS !== "undefined" && typeof FS.syncfs === "function") { FS.syncfs(false, function(error) { if (error) { console.error("Failed to sync payroll data.", error); } }); } }
};
